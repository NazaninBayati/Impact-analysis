import FileLevel.Main
import sys
import json

class score(FileLevel.Main.Main):
    ...
    def __init__(self):
        ...
        args_structural = 'File_level_ARM.txt'
        logical_db = FileLevel.Main.Main.Logical_data_load(str(args_logical))
        structural_db = FileLevel.Main.Main.Structural_data_load(str(args_structural))
        self.logical_db = logical_db
        self.structural_db = structural_db
